...
> **采购历程（已闭环）**：原 2026-05-08 的中国海运清单（11 件 ¥381 RMB）在 5-12~16 走中国海运被海关查扣全没 → itsuki 5-22 拍板撤回中国海运、改日本本地买 → 5-27 日本本地选型定稿（4 家：秋月電子 / Switch Science / Amazon Japan / ヨドバシ.com）→ **2026-06-04 三家全部下单完成**。完整渠道 / 价格 / 订单截图见 `02_design/hardware_design.md §5.1'` + `点呼机采购清单.html` + `采购截图/`，海关查扣 AC 素材见 `05_logs/raw/2026-05-22.md`。
