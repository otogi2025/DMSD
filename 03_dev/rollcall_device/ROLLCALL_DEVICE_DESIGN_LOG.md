...
- ✅ Pi 3A+ + PN532 V3 + ST25DV16K × 2 + LED 模块 + USB 小音响 + NTAG215 × 50 配件已确认（2026-05-08 itsuki 复核）
- ⏳ 配件实物到货
- ⏳ Pi OS 装好 + SSH 通
...
> **正式接线图待 hardware_design.md §2.4 LED / 喇叭 / 外壳定型 + 实物到货后绘制**

初步分配（CC 假设 🟡,待 itsuki 实物调试时改）：
