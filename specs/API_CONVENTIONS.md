...
更新时间：2026-07-06（§4 时间基准 —— 补过渡态 server_now / 点呼机波 swipe_time 两层边界）。此前：2026-06-09（按实际实装同步 §2 鉴权 / §8 URL 命名 / §13 URL 路径段 —— 关闭 L8；详见各节）；2026-04-22（§1 精化 + §8-§15 扩写 — S13 / L8 / S19）
