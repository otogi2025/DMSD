...
Claude Design の成果:
- 標準 HTML → `student_ios/designs/Tomoshibi_iOS_Round1.html`（8-10 MB 程度）
- Screenshot 一式 → `student_ios/designs/screenshots/`
- 日本語 校正 list → `student_ios/designs/wording_review.md`
