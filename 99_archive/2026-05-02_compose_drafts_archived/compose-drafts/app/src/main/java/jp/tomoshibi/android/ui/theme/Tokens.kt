...
data class SuzuTokens(
    ...
    // amber Card 渐变（Home hero 减点卡）— iOS 招牌琥珀
    val amberA: Color,
    val amberB: Color,
...
fun lightSuzuTokens() = SuzuTokens(
    isDark = false,
    warn = SuzuWarnLight,
    ...
    btnGrad = Brush.linearGradient(
        colors = listOf(SuzuAccentLight, SuzuPrimaryLight)
    ),
    amberGrad = Brush.linearGradient(
        colors = listOf(SuzuAmberALight, SuzuAmberBLight)
    ),
    rollGrad = Brush.radialGradient(
        colors = listOf(SuzuAccentSoftLight, SuzuAccentLight, SuzuPrimaryLight)
    )
)

fun darkSuzuTokens() = SuzuTokens(
    isDark = true,
    warn = SuzuWarnDark,
    ...
    amberGrad = Brush.linearGradient(
        colors = listOf(SuzuAmberADark, SuzuAmberBDark)
    ),
    rollGrad = Brush.radialGradient(
        colors = listOf(SuzuAccentSoftDark, SuzuAccentDark, SuzuPrimaryDark)
    )
)
