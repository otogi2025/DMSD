...
|---|---|---|
| **外泊（日本人）** | 担任・副担 → 寮務課長 → 寮務部長 → 管理係 = **4 人** ⚠️ | 保護者許可は学生提出時に家長サイン（システム外、紙書面）。实物表(5-28)确认印栏**含寮務部長** → 与旧记录「3 人无寮務部長」矛盾,见下方 ⚠️ 矛盾点 1 |
| **外泊（留学生）** | 担任 → 国際交流部長 → 寮務課長 → 寮務部長 → 管理係 = **5 人** | 留学生比日本人多「国際交流部長」一栏(CC + codex 双读 + 旧记录一致)|
| **帰省（日本人 / 留学生 通用表）** | 担任・副担 → 寮務課長 → 寮務部長 → 管理係 = **4 人** ✅ 实物补齐(5-28) | 通常時用 / 長期休暇用 两张表 chain 相同;实物表未分日本人 / 留学生版,确认印栏**无国際交流部長**,见 ⚠️ 矛盾点 2 |
| **帰国（日本人 / 留学生）** | ⏳ 仍待确认 | 「届け類.pdf」9 种表单**无单独帰国届实物** — 待 itsuki 确认学校是否有独立帰国表(还是回国就走帰省 / 外泊表)。老师 LINE「外泊と同じ」歧义未解 |

> ⚠️ **矛盾点 1(2026-05-28 — 待 itsuki 拍板)**: 旧 §7.2.2 记「日本人外泊 = 担任 + 寮務課長 + 管理係 = 3 人,印欄に寮務部長なし」(2026-04-30 记录)。但 5-28 实物表「外泊許可願(日本人・通常時用)」确认印栏明确是「保護者許可 / 担任・副担 / 寮務課長 / **寮務部長** / 管理係」,CC 与 codex 独立双读都看到寮務部長。按 itsuki「实物表为准」铁律,上表已改为 4 人(含寮務部長)。**待 itsuki 确认**: 是 4-30 当时漏记寮務部長,还是手头两版表不同?

> ⚠️ **矛盾点 2(2026-05-28 — 待 itsuki 拍板)**: 帰省实物表(通常時 + 長期休暇)是**通用表,没分日本人版 / 留学生版**,确认印栏只有 4 人无国際交流部長。但外泊届留学生要多一个国際交流部長。**待 itsuki 确认**: 留学生帰省是否也需要国際交流部長(实物通用表没体现,可能学校口头另有要求),还是帰省留学生也只走 4 人链?

**役职差异**（外泊 / 帰省届 chain 上,2026-05-28 实物校正后）:
- 日本人外泊 / 帰省：印欄に **国際交流部長 / 国際交流課長 なし**（⚠️ 寮務部長 **あり** — 5-28 实物校正,旧记「寮務部長なし」有误,见 ⚠️ 矛盾点 1）
