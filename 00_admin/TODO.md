...
## 📦 raw（AC 素材正本）迁不迁 iCloud（2026-06-10 两轮态度相反，待最终拍板）

- 一轮说「AC 素材放项目丢人、教授读不了中文，直接放 iCloud」；后一轮说「三记录文件全要留项目，不嫌素材多」。raw 本身去留没拍。
- 不急：GitHub 历史清理会把 05_logs 从公开仓库抹掉，外人看不到。维持现状（raw 留项目）直到拍板。
