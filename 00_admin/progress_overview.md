...
> **最后更新**: 2026-04-17 晚（头部版本号于 2026-04-19 改为指针）
> **当前版本**: 见 `CHANGELOG.md` 顶部（单源真值，见 `00_admin/文档同步点清单.md §1`）
> **版本细粒度**: CHANGELOG 已于 2026-04-17 晚重建，pre-0.1 追认 + 2-02 至今每个实质节点一条 patch
>
> ⚠️ **2026-04-19 G2 决策后本文件部分章节过期**（如"分阶段策略(2026-04-12 决定)"整块需改为 v1.0 完整版 + M1-M5 内部节奏）。**待 itsuki 下次会话通览章节级更新**（CC 不直写，见 `CLAUDE.md §会话开始`）。
>
