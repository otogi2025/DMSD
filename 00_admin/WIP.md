...
**当前版本**: v0.23.5 <!-- VERSION_OK -->（2026-06-12 iOS 公告翻訳重做 — 原地翻译 + 4 语言选择 + 默认语言 + 设置页升级；patch）。早些（2026-06-12 v0.23.4 老师权限分级 codex 审查四项修复 — F2/F1/F4/F5）。早些（2026-06-11 深夜「版本当场结账」首战 — iOS 体验功能批次 + 首批 7 条单元测试 + 管理基建搭车）。早些（2026-06-11 插空细分：老段号位空隙补打 70 个补丁标签 v0.3.3~v0.14.8（已 push 旧标签与 commit 全未动）+ 新段补 v0.20.0~v0.22.3，标签总数 143；详见 CHANGELOG 顶部「2026-06-11 插空细分说明」。更早：2026-06-09 重排 v0.15.1~v0.19.3 ×32）
