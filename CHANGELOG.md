...
| **v0.23.10** | **2026-06-14** | **补丁：iOS 上线前审查 Tier2/Tier3 修复批（JST 时区选择性 10 + 枚举 Bool 收紧 + 日语明显 30 + 其他 bug 11 + 漏洞中低纵深 6 + Tier3 润色 26+小bug3）+ 同区间并行（多会话补记）：注册码对全权限组+演示账号放开 `aa1ee98` ← 当前版本** |
