...
| **v0.23.9** | **2026-06-14** | **补丁：iOS 上线前审查 Tier1 修复批（日语残留+防抖 8 表单+NFC 生产不伪置 done+中危漏洞 4 类+codex 复审）← 当前版本** |
