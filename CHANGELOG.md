...
| **v0.23.6** | **2026-06-13** | **补丁：后端启动 schema 落后自检（`_warn_if_db_schema_outdated`，dev 启动比对 alembic head 打 WARNING）← 当前版本** |
