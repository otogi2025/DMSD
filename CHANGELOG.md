...
| **v0.38.0** | **2026-07-29** | **minor：真硬件首次跑通 + 苹果演示视频冲刺（ST25DV RF 侧指针 0x06→0x0D 阻断 bug + 两处静默丢签到 + iOS 一按就扫·签到完成态）← 当前版本** |
