...
enum SEED {
    ...
    //   生产通知源 = 真公告（AppStore.announcementNotifications）+ 真 push。
        ...
        static let notifications: [NotificationItem] = [
            ...
            .init(id: 3, type: "減点", title: "遅刻警告", time: "昨日 9:00", body: "今月の遅刻が5回に達しました", unread: false),
            .init(id: 4, type: "活動", title: "明日 18:00 誕生日会", time: "昨日", body: "カフェテリア集合", unread: true),
            .init(id: 5, type: "リクエスト曲", title: "リクエストした曲が採用されました", time: "2 日前", body: "Lemon / 米津玄師", unread: false),
        ]
    #endif
    ...
    /// 詳細は DMSD/design/bus_schedule_real.md 参照
